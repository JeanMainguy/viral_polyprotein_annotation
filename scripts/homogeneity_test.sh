...
file='data/clustering_result/Viruses/inflation_test/Viruses_1e-5_coverage50_I8.out'

homogeneity_dir='test/'

#
python3 scripts/taxonomic_homogeneity_checking.py $file $homogeneity_dir $taxonomy_file $alternative_taxon_id_file $unclassified_term_file visualisation
